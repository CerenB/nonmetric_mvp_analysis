...
#              f$p.value, g$p.value, h$p.value, i$p.value, i$p.value)
...
# 10/05/2024 - Nonmetric decoding with RhythmBlock AllSouds vs. Rest contrast

# 16/05/2024 - Complex decoding with RhythmBlock AllSouds vs. Rest contrast
###############################################################################
min(subsetmvpa$accuracy, na.rm = TRUE)
max(subsetmvpa$accuracy, na.rm = TRUE)

setlimit = c(30,90) 
setbreak = c(30, 50, 70, 90)


rois = 'RhythmBlockROI_P1'
...
# colors 
nonmetricGrayBad = "#9ec5aa" # complex green= 3d8c55ff, nonmetricGrap = 6B6B6B 
nonmetricGrayGood = "#6B6B6B" 
simplePurpleBad = "#c4a4c9"
simplePurpleGood = "#8a4a95"

# conditions
cond = 'Nonmetric' # complex
legendText = paste0(" Simple vs. ", cond)
#xLabel = c("L STG ", "R STG","SMA","L Premotor","R Premotor","Cereb")
